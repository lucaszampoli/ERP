          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'name') { ?>
                   ...
                   <td class="text-right"><?php if ($sort == 'sort_order') { ?>
                    ...
                    <?php } ?></td>
                     <td class="text-right" style="width:200px !important"><a> Dias para pagamento</a></td>
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($payment_method['payment_method_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['category_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $category['category_id']; ?>" />
                    <?php } ?></td>
                  <td class="text-left"><?php echo $payment_method['name']; ?></td>
                  <td class="text-right"><?php echo ( $payment_method['active'] == 1 ) ? 'Ativo' : 'Desabilitado'; ?></td>
                   <td class="text-right"><?php echo $payment_method['days_to_payment']; ?></td>
                  <td class="text-right"><a href="<?php echo $payment_method['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
