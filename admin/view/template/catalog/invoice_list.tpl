            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  <td style="width: 1px;" class="text-center"><input type="checkbox" onclick="$('input[name*=\'selected\']').prop('checked', this.checked);" /></td>
                    ...
                    <td class="text-right">Data do faturamento</td>
                     <td class="text-right">Valor</td>
                     <td class="text-right">Clientes atentidos</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php echo date("d/m/Y",strtotime($invoice['date_receiving_payment'])); ?></td>
                  <td class="text-right"><?php echo number_format($invoice['invoice_value'], 2,',','.'); ?></td>
                  <td class="text-right"><?php echo $invoice['customer_attended']; ?></td>
...
$('#button-filter').on('click', function() {
	url = 'index.php?route=catalog/invoice&token=<?php echo $token; ?>';
