      ...
      <div class="panel-body">
       ...
       <div class="col-lg-6">
                        ...
                        <div class="panel-heading"><h6>
                            <i class="fa fa-list fa-fw"></i> Faturamento das Lojas </h6>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                             <div class="col-lg-11">
         ...
         <div class="col-lg-6">
                        <div class="panel panel-default">
                        <div class="panel-heading"><h6>
                            <i class="fa fa-list fa-fw"></i> Despesas das Lojas </h6>
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                             <div class="col-lg-11">
                                 ...
                                 <table class="table">
												...
												foreach( $expenses as $expense) { ?>
													<tr>
														<td style="font-size:10px"><?php echo $expense['loja']; ?></td>
														<td style="font-size:10px" > R$<?php echo number_format($expense['expense_value'], 2,',', '.'); ?></td>
														<td style="font-size:10px" ><?php echo $expense['date_purchase']; ?></td>
