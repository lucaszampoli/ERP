...
<?php } ?>
<link href="view/image/favicon1.png" rel="icon" />
</head>
<body>
<div id="container">
<header id="header" class="navbar navbar-static-top">
  ...
  <!--    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><?php if($alerts > 0) { ?><span class="label label-danger pull-left"><?php echo $alerts; ?></span><?php } ?> <i class="fa fa-bell fa-lg"></i></a>
    ...
    <li ><a href="<?php echo $home; ?>" ><i class="fa fa-home fa-lg"></i></a>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-123489760-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-123489760-1');
</script>