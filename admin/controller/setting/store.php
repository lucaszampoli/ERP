...
class ControllerSettingStore extends Controller {
	...
	{
		$this->load->model('catalog/store_type');
		$this->load->model('catalog/brand');
		$this->load->model('setting/store');

		$data['types'] = $this->model_catalog_store_type->getTypesList();
		$data['brands'] = $this->model_catalog_brand->getBrandsList();
		$data['heading_title'] = $this->language->get('heading_title');
		...
		if (isset($this->request->get['store_id']) && ($this->request->server['REQUEST_METHOD'] != 'POST'))
		{
			...
			$data['partners'] = $this->model_setting_store->getStorePartnersByStoreId($this->request->get['store_id'] );
			$data['ensigns'] = $this->model_setting_store->getStoreEnsignsByStoreId($this->request->get['store_id']);
		}

		$data['token'] = $this->session->data['token'];

		if (isset($this->request->post['store_value'])) {
			$data['store_value'] = $this->request->post['store_value'];
		} elseif (isset($store['store_value'])) {
			$data['store_value'] = $store['store_value'];
		} else {
			$data['store_value'] = '';
		}
		...
		} elseif (isset($store['target'])) {
			$data['target'] = $store['target'];
		} else {
			$data['target'] = '';
		}

		if (isset($this->request->post['break_even'])) {
			$data['break_even'] = $this->request->post['break_even'];
		} elseif (isset($store['break_even'])) {
			$data['break_even'] = $store['break_even'];
		} else {
			$data['break_even'] = '';
		}

		if (isset($this->request->post['store_type_id'])) {
			$data['store_type_id'] = $this->request->post['store_type_id'];
		} elseif (isset($store['store_type_id'])) {
			$data['store_type_id'] = $store['store_type_id'];
		} else {
			$data['store_type_id'] = '';
		}
		...
		} elseif (isset($store['brand_id'])) {
			$data['brand_id'] = $store['brand_id'];
		} else {
			$data['brand_id'] = '';
		}
		...
		} elseif (isset($store['cnpj'])) {
			$data['cnpj'] = $store['cnpj'];
		} else {
			$data['cnpj'] = '';
		}

		if (isset($this->request->post['ie'])) {
			$data['ie'] = $this->request->post['ie'];
		} elseif (isset($store['ie'])) {
			$data['ie'] = $store['ie'];
		} else {
			$data['ie'] = '';
		}

		if (isset($this->request->post['ccm'])) {
			$data['ccm'] = $this->request->post['ccm'];
		} elseif (isset($store['ccm'])) {
			$data['ccm'] = $store['ccm'];
		} else {
			$data['ccm'] = '';
		}
	...
	public function getFormAddPartner()
	{
		$this->load->model('user/user');
		$data['users'] = $this->model_user_user->getUsersList();
		$data['groups'] = $this->model_user_user->getGroupsList();

		$this->response->setOutput($this->load->view('setting/add_partner', $data));
	}

	public function addStorePartner()
	{
		$this->load->model('setting/store');

		$data['store'] = $this->request->get['store'];
		$data['user'] = $this->request->get['user'];
		$data['group'] = $this->request->get['group'];
		$data['investiment'] = $this->request->get['investiment'];
		$data['percentage'] = $this->request->get['percentage'];

		$id = $this->model_setting_store->addStorePartner($data);

		print $id;
	}

	public function getStorePartnerList()
	{
		$this->load->model('setting/store');
		$data['token'] = $this->session->data['token'];
		...
		$data['partners'] = $this->model_setting_store->getStorePartnersByStoreId($store);
		
		$this->response->setOutput($this->load->view('setting/partner_list', $data));
	}
	
	public function getFormEditPartner()
	{
		$this->load->model('setting/store');
		$this->load->model('user/user');
		...
		$data['users'] = $this->model_user_user->getUsersList();
		$data['groups'] = $this->model_user_user->getGroupsList();
		$data['partner'] = $this->model_setting_store->getPartner($this->request->get['store_partner_id']);

		$this->response->setOutput($this->load->view('setting/edit_partner', $data));
	}
	...
	public function editPartner()
	{
		...
		$this->load->model('setting/store');
		$data['store_partner_id'] = $this->request->get['store_partner_id'];
		$data['store'] = $this->request->get['store'];
		$data['user'] = $this->request->get['user'];
		$data['group'] = $this->request->get['group'];
		$data['investiment'] = $this->request->get['investiment'];
		...
		$id = $this->model_setting_store->editPartner($data);
	...
	public function getFormAddEnsign()
	{
		$this->load->model('setting/store');

		$data['payment_methods'] = $this->model_setting_store->getPaymentMethods();	
		
		$this->response->setOutput($this->load->view('setting/add_ensign', $data));
	}

	public function addStoreEnsign()
	{
		$this->load->model('setting/store');

		$data['store'] = $this->request->get['store'];
		$data['payment_method_id'] = $this->request->get['payment_method_id'];
		$data['ensign_value'] = $this->request->get['ensign_value'];

		$id = $this->model_setting_store->addStoreEnsign($data);

		print $id;
	}

	public function getStoreEnsignList()
	{
		$this->load->model('setting/store');
		$data['token'] = $this->session->data['token'];
		...
		$data['ensigns'] = $this->model_setting_store->getStoreEnsignsByStoreId($store);

		$this->response->setOutput($this->load->view('setting/ensign_list', $data));
	}
	
   public function getFormEditEnsign()
	{
		$this->load->model('setting/store');

		$data['token'] = $this->session->data['token'];
		$data['payment_methods'] = $this->model_setting_store->getPaymentMethods();	
		$data['ensign'] = $this->model_setting_store->getEnsign($this->request->get['store_ensign_id']);

		$this->response->setOutput($this->load->view('setting/edit_ensign', $data));
	}

	public function editEnsign()
	{
		
		$this->load->model('setting/store');
		$data['store_ensign_id'] = $this->request->get['store_ensign_id'];
		$data['store'] = $this->request->get['store'];
		$data['payment_method_id'] = $this->request->get['payment_method_id'];
		$data['ensign_value'] = $this->request->get['ensign_value'];
        
		$id = $this->model_setting_store->editEnsign($data);
