...
*/
			...
			if ($this->user->hasPermission('access', 'catalog/category')) {
				$catalog[] = array(
					...
					'href'     => $this->url->link('catalog/cost_center', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			
			//Aqui fica o produtos
			...
			if ($this->user->hasPermission('access', 'catalog/payment_method')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_payment_method'),
					'href'     => $this->url->link('catalog/payment_method', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
		
			if ($this->user->hasPermission('access', 'catalog/expense')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_expense'),
					'href'     => $this->url->link('catalog/expense', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			
			if ($this->user->hasPermission('access', 'catalog/invoice')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_invoice'),
					'href'     => $this->url->link('catalog/invoice', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			
		   if ($this->user->hasPermission('access', 'catalog/preview_invoice')) {
				$catalog[] = array(
					'name'	   => $this->language->get('text_preview_invoice'),
					'href'     => $this->url->link('catalog/preview_invoice', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			//Aqui fica o Filtros
			...
			if ($this->user->hasPermission('access', 'catalog/store_type')) {
				$catalog[] = array(
					'name'	   => 'Tipo de Loja',
					'href'     => $this->url->link('catalog/store_type', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/brand')) {
				$catalog[] = array(
					'name'	   => 'Marcas',
					'href'     => $this->url->link('catalog/brand', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			//Aqui fica a pagina de informações
